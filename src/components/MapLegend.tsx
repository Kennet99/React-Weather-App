...
export default function MapLegend({ mapType }: MapType) {
  ...
  return (
    <div className="absolute top-4 right-4 z-1000 w-80 rounded-xl shadow-lg p-4 bg-background/50 border-accent/80 flex flex-col gap-4">
      <h3 className="text-sm font-semibold">{data.title}</h3>
      <div
        className="w-full rounded-xl border border-accent/80 h-4"
        style={{
